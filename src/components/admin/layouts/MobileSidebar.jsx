...
import { Home, Users, Shield, Key, Eye, ChevronDown, LogOut, X, DoorOpen, Clock, RefreshCw, Truck } from 'lucide-react';
...
export default function MobileSidebar({ isOpen, onClose }) {
  ...
  const menuItems = useMemo(() => [
    ...
    { 
      ...
      label: 'Management',
      subItems: [
        { icon: Users, label: 'Users', href: '/admin-portal/users' },
        { icon: Shield, label: 'Roles', href: '/admin-portal/roles' },
        { icon: Key, label: 'Permissions', href: '/admin-portal/permissions' },
        { icon: Clock, label: 'Shifts', href: '/admin-portal/shifts' },
        { icon: DoorOpen, label: 'Gates', href: '/admin-portal/gates' },
    ...
    { 
      ...
      label: 'Reports',
      subItems: [
        { icon: RefreshCw, label: 'Guard Shifts', href: '/admin-portal/guard-shifts' },       
        { icon: Eye, label: 'Visitors', href: '/admin-portal/visitors' },
        { icon: Eye, label: 'Visits', href: '/admin-portal/visits' },
        { icon: Truck, label: "Delivery Reports", href: "/admin-portal/delivery-reports" }
      ]
    },
  ], []);
